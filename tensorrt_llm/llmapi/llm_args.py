...
class CudaGraphConfig(BaseModel):
    ...
    @classmethod
    def from_dict(cls, config: dict) -> 'CudaGraphConfig':
        """Create a CudaGraphConfig instance from a dict.

        Args:
            config (dict): The dict used to create CudaGraphConfig.

        Returns:
            tensorrt_llm.llmapi.CudaGraphConfig: The CudaGraphConfig created from dict.
        """
        return cls(**config)

    def to_dict(self) -> dict:
        """Dump a CudaGraphConfig instance to a dict.

        Returns:
            dict: The dict dumped from CudaGraphConfig.
        """
